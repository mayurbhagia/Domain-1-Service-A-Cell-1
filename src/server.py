...
@app.route('/')
def home():
    print("inside method home  of Domain-1-Service-A-Cell-1.internal-Domain1-GS.com This is cell 1")
    response1 = requests.get("http://Domain1-ServiceB-Cell1.internal-Domain1-GS.com:5001/")
